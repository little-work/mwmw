...
public class MyAspects {
     ...
     */
    @Pointcut("execution(public * com.lilin.mwmw.aop.aopApply.TargetMethod.*(..))")
    public void pointCut() {
    }


    //目标方法之前切入：切入的表达式
    //@Before("public void com.lilin.mwmw.aop.aopApply.TargetMethod.execute()")  只是指定具体的类中的那个方法
    ...
    @After("com.lilin.mwmw.aop.aopApply.MyAspects.pointCut()")
